...
ax = fig.add_subplot(111)
plt.loglog(b/(mod_isochor.unmodified.Halo.r200*mod_isochor.unmodified.Halo.UNIT_LENGTH/kpc), NOVI, 
           label=r'isothermal with isochoric modification', linewidth=5)
