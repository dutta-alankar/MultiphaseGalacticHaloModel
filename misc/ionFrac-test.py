...
ax  =  plt.gca()
plt.loglog(temperature, fracIon_PIE, label='interpolated PIE OVI', linewidth=5)
plt.loglog(temperature, fracIon_CIE, label='interpolated CIE OVI', linewidth=5)
ax.grid()   
...
plt.loglog(temperature, fracIon_PIE, label='interpolated PIE NV', linewidth=5)
plt.loglog(temperature, fracIon_CIE, label='interpolated CIE NV', linewidth=5)
...
plt.loglog(temperature, fracIon_PIE, label='interpolated PIE MgII', linewidth=5)
plt.loglog(temperature, fracIon_CIE, label='interpolated CIE MgII', linewidth=5)

compare_cloudy = False
if (compare_cloudy):
    X_solar = 0.7154
    Y_solar = 0.2703
    Z_solar = 0.0143
