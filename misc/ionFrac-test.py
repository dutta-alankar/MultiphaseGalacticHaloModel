...
ax  =  plt.gca()
plt.loglog(temperature, fracIon_PIE, label='interpolated PIE')
plt.loglog(temperature, fracIon_CIE, label='interpolated CIE')
ax.grid()   
...
plt.loglog(temperature, fracIon_PIE, label='cloudy PIE')
plt.loglog(temperature, fracIon_CIE, label='cloudy CIE')
