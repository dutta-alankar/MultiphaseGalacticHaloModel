...
halo_url  = f"https://www.tng-project.org/api/TNG50-1/snapshots/{snapnum}/halos/{haloID}/"
...
redshift = np.array(get(f"https://www.tng-project.org/api/{simulation}/snapshots/")[snapnum]['redshift'])
a = 1/(1+redshift)
ckpc = UnitLength/a
