...
from observable.HaloEmissionSpectrum import luminosity_spectrum_gen
...
def spectrum(unmod: str, mod: str, ionization: str) -> None: 
    ...
    spectrum   =  luminosity_spectrum_gen(modified)
    
    with open(f'figures/spectrum_{unmod}_{mod}_{ionization}.pickle', 'wb') as f:
        data = {'energy': spectrum[:,0],
                'luminosity': spectrum[:,1],
